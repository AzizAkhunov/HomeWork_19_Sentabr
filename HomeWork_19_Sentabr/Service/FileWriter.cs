    ...
    public static class FileWriter
    {
        ...
        public static void Generatsion(string SubjectName, int countStudent, int countTest)
        {
            ...
            if (s.Count >= countStudent * countTest)
            {
                ...
                {
                    using (StreamWriter streamWriter = new StreamWriter($"C:\\Users\\Windows 10 Pro\\source\\repos\\HomeWork_19_Sentabr\\{i + 1}.txt"))
                    {
                ...
                Console.WriteLine("File Writing is ended");

            }
            else
            {
                Console.WriteLine("Test numbers not current");
            }
